...
sub main{
  my $settings={};
  GetOptions($settings,qw(help tempdir=s numcpus=i genomesize=i mindepth=i reps=i truncLength=i warn-on-duplicate validate-reads save-space kmerlength=i)) or die $!;
  $$settings{numcpus}||=1;
